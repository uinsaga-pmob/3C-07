    ...
    'Fritters': [
      {
        'name': 'French Fries',
        'price': 'Rp.23.000',
        'image': 'assets/food/french_fries.jpg',
      ...
      },
      {
        'name': 'Mix Platter',
        'price': 'Rp.32.000',
        'image': 'assets/food/mix_platter.jpg',
        'description': 'Campuran berbagai gorengan',
      },
      {
        'name': 'Tahu Crispy',
        'price': 'Rp.18.000',
        'image': 'assets/food/tahu_crispy.jpg',
        'description': 'Tahu goreng crispy',
      },
      {
        'name': 'Tempe Mendoan',
        'price': 'Rp.15.000',
        'image': 'assets/food/tempe_mendoan.jpg',
    ...
    'Drink': [
      {
        'name': 'Coca-Cola (M)',
        'price': 'Rp.18.000',
        'image': 'assets/food/coca_cola_m.jpg',
        'description': 'Coca-Cola ukuran sedang',
      },
      {
        'name': 'Pepsi (M)',
        'price': 'Rp.17.000',
        'image': 'assets/food/pepsi_m.jpg',
        'description': 'Pepsi ukuran sedang',
      },
      {
        'name': 'Fanta (M)',
        'price': 'Rp.17.000',
        'image': 'assets/food/fanta_m.jpg',
        'description': 'Fanta ukuran sedang',
      },
      {
        'name': 'Air Mineral',
        'price': 'Rp.10.000',
        'image': 'assets/food/air_mineral.jpg',
        'description': 'Air mineral botol',
      },
      {
        'name': 'Ice Tea',
        'price': 'Rp.15.000',
        'image': 'assets/food/ice_tea.jpg',
